#ifndef NODES_CORE_UTF16_H
#define NODES_CORE_UTF16_H

#include "desc.h"
#include "opentype-features.h"

math_shape_desc_t* parse_utf16(uint16_t * text, unsigned int lenght, Font* font, const char* features = nullptr) {
