#ifndef NODES_CORE_UTF8_H
#define NODES_CORE_UTF8_H

#include "desc.h"
#include "opentype-features.h"

math_shape_desc_t* parse_utf8(std::string text, Font* font, const char* features = nullptr) {
